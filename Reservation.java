...
public class main {
    ...
    public static void main(String[] args) {
        ...
        while(loop) {
            ...
            System.out.println("Patna-Delhi\t\t" +  "2:05\t\t\t\t\t" + firsttrain + "\t\t\t\t\t1010(patna Superfast)");
            System.out.println("Delhi-Jaipur\t\t" + "6:00\t\t\t\t\t" + secondtrain + "\t\t\t\t\t2013(Delhi SuperFast)");
            System.out.println("Mumbai-Delhi\t\t" + "9:00\t\t\t\t\t" + thirdtrain + "\t\t\t\t\t3045(Mumbai Superfast)"+ANSI_RESET);
            System.out.println("*****************************************************************************");
